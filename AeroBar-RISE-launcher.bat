...
echo. NOTE: The MadMapper project is openend in READ-Only mode.
echo.       Saved modifications will be lost on exit.
echo.
...
if exist "C:\Program Files\MadMapper 5.6.6\MadMapper.exe" (
    start "" "C:\Program Files\MadMapper 5.6.6\MadMapper.exe" "%USERPROFILE%\Documents\RISE.mad"
    echo MadMapper started with Documents\RISE.mad
) else (
